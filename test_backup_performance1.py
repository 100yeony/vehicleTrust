...
def make_chart_1(mal_v_num, accuracy_list):
    # x축 : list 길이 같아야
    # y축 : list 길이 같아야 함
    print(accuracy_5)
...
def make_mal(origin_v_list, mal_cnt):
    ...
    for i in mal_user_id:
        mal_user.append(i[1])
    return mal_user_id, mal_user, mal_vehicle
...
mal_user_id, mal_user, mal_vehicle_5 = make_mal(origin_v_list, 5)
print('==================5==================')
print('mal_user_id =',mal_user_id)
print('mal_user =',mal_user)
print('mal_vehicle =',sorted(mal_vehicle_5))

target_5, find_5 = carTrust(mal_vehicle_5)
print('target =', target_5)
print('find =', find_5)
accuracy_5, precision, recall, f1 = make_performance(target_5, find_5)


mal_user_id, mal_user, mal_vehicle_10 = make_mal(origin_v_list, 10)
print('==================10==================')
print('mal_user_id =',mal_user_id)
print('mal_user =',mal_user)
print('mal_vehicle =',sorted(mal_vehicle_10))

target_10, find_10 = carTrust(mal_vehicle_10)
print('target =', target_10)
print('find =', find_10)
accuracy_10, precision, recall, f1 = make_performance(target_10, find_10)



mal_user_id, mal_user, mal_vehicle_15 = make_mal(origin_v_list, 15)
print('==================15==================')
print('mal_user_id =',mal_user_id)
print('mal_user =',mal_user)
print('mal_vehicle =',sorted(mal_vehicle_15))

target_15, find_15 = carTrust(mal_vehicle_15)
print('target =', target_15)
print('find =', find_15)
accuracy_15, precision, recall, f1 = make_performance(target_15, find_15)



mal_user_id, mal_user, mal_vehicle_20 = make_mal(origin_v_list, 20)
print('==================20==================')
print('mal_user_id =',mal_user_id)
print('mal_user =',mal_user)
print('mal_vehicle =',sorted(mal_vehicle_20))

target_20, find_20 = carTrust(mal_vehicle_20)
print('target =', target_20)
print('find =', find_20)
accuracy_20, precision, recall, f1 = make_performance(target_20, find_20)

accuracy_list = [accuracy_5, accuracy_10, accuracy_15, accuracy_20]
#===================================================================
#------------------- mix data 직렬화&역직렬화 2 end -----------------
#===================================================================
# accuracy, precision, recall, f1 = make_performance(target_5, find_5)
# accuracy, precision, recall, f1 = make_performance(target_10, find_10)
# accuracy, precision, recall, f1 = make_performance(target_15, find_15)
# accuracy, precision, recall, f1 = make_performance(target_20, find_20)
...
make_chart_1(mal_v_num, accuracy_list)
